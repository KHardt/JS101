...
article.id = "messages"
//article.appendChild()-- //need to append it on the dom to work
console.log(article)
...
fragment.appendChild(createSection1)
fragment.appendChild(createSection2)
fragment.appendChild(createSection3)
fragment.appendChild(createSection4)
fragment.appendChild(createSection5)

console.log(fragment)
//fragment part is working with body tag only...
document.getElementById("output").appendChild(fragment)


//i need to use body. document.body.....
